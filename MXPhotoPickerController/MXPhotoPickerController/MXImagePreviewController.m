...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.backButton setImage:[UIImage imageNamed:@"picker_back_image.png"] forState:UIControlStateNormal];
        
        self.stateButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [self.stateButton setImage:[UIImage imageNamed:@"pic_selected_no.png"] forState:UIControlStateNormal];
        [self.stateButton setImage:[UIImage imageNamed:@"pic_selected_yes.png"] forState:UIControlStateSelected];
