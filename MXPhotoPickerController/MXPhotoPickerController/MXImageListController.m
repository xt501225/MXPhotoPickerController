...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.stateView setImage:[UIImage imageNamed:@"pic_selected_no.png"] forState:UIControlStateNormal];
        [self.stateView setImage:[UIImage imageNamed:@"pic_selected_yes.png"] forState:UIControlStateSelected];
